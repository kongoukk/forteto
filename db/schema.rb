...
ActiveRecord::Schema.define(version: 2024_07_22_120301) do
  ...
  create_table "post_relationships", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["post_id", "tag_id"], name: "index_post_relationships_on_post_id_and_tag_id", unique: true
    t.index ["post_id"], name: "index_post_relationships_on_post_id"
    t.index ["tag_id"], name: "index_post_relationships_on_tag_id"
  end
  ...
  add_foreign_key "post_relationships", "tags"
end
